import { getDate } from "~/utils/parse-date";
...
`,
	},
	{
		...
		description:
			"bidirectional translator from proprietary text documents to XML",
	},
	{
		company: "Eldis",
